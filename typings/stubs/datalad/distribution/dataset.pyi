...
class EnsureDataset(Constraint):
    ...
    def __call__(self, value): # -> Dataset | str:
        ...
    
    def short_description(self): # -> Literal['Dataset']:
        ...
    
    def long_description(self): # -> Literal['Value must be a Dataset or a valid identifier of a…']:
        ...
...
def resolve_path(path, ds=...): # -> list[Unknown]:
