...
class RegionExtractor(NiftiMapsMasker):
 ...
 'percentile'}, optional
    ...
    """
    def __init__(self, maps_img, mask_img=..., min_region_size=..., threshold=..., thresholding_strategy=..., extractor=..., smoothing_fwhm=..., standardize=..., detrend=..., low_pass=..., high_pass=..., t_r=..., memory=..., memory_level=..., verbose=...) -> None:
        ...
...
def connected_label_regions(labels_img, min_size=..., connect_diag=..., labels=...): # -> tuple[Nifti1Image | FileBasedImage | Unknown, list[Unknown]] | Nifti1Image | FileBasedImage:
