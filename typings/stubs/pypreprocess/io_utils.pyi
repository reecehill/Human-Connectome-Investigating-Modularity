...
def load_vols(niimgs): # -> list[Unknown] | list[Nifti1Image]:
...
def dcm2nii(source_names, terminal_output=..., gzip_output=..., anonymize=..., output_dir=..., caching=..., **other_dcm2nii_kwargs): # -> tuple[Unknown, None] | tuple[str | Unknown, None] | tuple[Unknown, Unknown]:
    """
