...
try
    ...
    matlabbatch{5}.spm.spatial.coreg.estwrite.other = {[pathToParticipants '\' subject '\data\bert\mri\gm.nii,1']};
    ...
    matlabbatch{13}.spm.stats.results.export{1}.binary.basename = 'allClusters';
