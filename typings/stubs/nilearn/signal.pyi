...
availiable_filters = ...
@fill_doc
def butterworth(signals, sampling_rate, low_pass=..., high_pass=..., order=..., copy=...): # -> NDArray[Any]:
...
@fill_doc
def clean(signals, runs=..., detrend=..., standardize=..., sample_mask=..., confounds=..., standardize_confounds=..., filter=..., low_pass=..., high_pass=..., t_r=..., ensure_finite=...): # -> NDArray[Unknown] | ndarray[Unknown, Unknown] | spmatrix | Any:
