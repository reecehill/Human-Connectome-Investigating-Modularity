...
def logm(A, disp=...): # -> Any | ndarray[Any, _dtype[Any]] | tuple[Any | ndarray[Any, _dtype[Any]], Any | floating[Any]]:
    """
...
def tanm(A): # -> ndarray[Any, _dtype[floating[_64Bit]]]:
    """
...
def tanhm(A): # -> ndarray[Any, _dtype[floating[_64Bit]]]:
    """
