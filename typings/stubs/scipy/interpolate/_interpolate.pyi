...
class NdPPoly:
    ...
    def integrate(self, ranges, extrapolate=...): # -> NDArray[Any] | NDArray[complexfloating[_NBitDouble, _NBitDouble] | floating[_NBitDouble]] | Any | ndarray[Any, dtype[complexfloating[Any, Any]]]:
        """
        Compute a definite integral over a piecewise polynomial.
