...
def splev(x, tck, der=..., ext=...): # -> ndarray[Any, dtype[complexfloating[_NBitDouble, _NBitDouble] | floating[_NBitDouble]]] | list[Any] | Any:
    """
...
def sproot(tck, mest=...): # -> list[Any] | Any:
    """
