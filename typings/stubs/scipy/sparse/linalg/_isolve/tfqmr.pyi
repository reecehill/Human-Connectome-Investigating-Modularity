...
__all__ = ['tfqmr']
def tfqmr(A, b, x0=..., *, rtol=..., atol=..., maxiter=..., M=..., callback=..., show=...): # -> tuple[ndarray[Any, dtype[Any]], Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Any]] | Any, Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Any]] | Any, Literal[-1]] | tuple[Any, Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Any]] | Any, int | Any]:
    """
