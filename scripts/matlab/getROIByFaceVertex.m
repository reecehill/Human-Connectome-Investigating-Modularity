function [ROIfacevert] = getROIByFaceVertex(pathToFile,subjectId)
...
%     parfor i=1:nROISub
%         ROIfacevert(nROI+i,1).id=subfilenames(i);
%         ROIfacevert(nROI+i,1).faces=importfile([pathToFile,'/MNINonLinear/',subjectId,'/label/label_type2/',subfilenames{i}]);  
%     end
end