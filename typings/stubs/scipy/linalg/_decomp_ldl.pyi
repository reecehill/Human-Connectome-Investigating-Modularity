...
__all__ = ['ldl']
def ldl(A, lower=..., hermitian=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[floating[_NBitDouble]], NDArray[floating[_NBitDouble]], NDArray[Any]] | tuple[Any, NDArray[Any], NDArray[intp]]:
