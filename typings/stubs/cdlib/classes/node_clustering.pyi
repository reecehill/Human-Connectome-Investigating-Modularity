...
class NodeClustering(Clustering):
    ...
    def modularity_overlap(self, weight: str = ...) -> evaluation.FitnessResult:
    ...
    def normalized_mutual_information(self, clustering: Clustering) -> evaluation.MatchingResult:
        """
    ...
    def overlapping_normalized_mutual_information_LFK(self, clustering: Clustering) -> evaluation.MatchingResult:
        """
    ...
    def overlapping_normalized_mutual_information_MGH(self, clustering: Clustering, normalization: str = ...) -> evaluation.MatchingResult:
        """
        Overlapping Normalized Mutual Information between two clusterings.
    ...
    def adjusted_mutual_information(self, clustering: Clustering) -> evaluation.MatchingResult:
        """
    ...
    def variation_of_information(self, clustering: Clustering) -> evaluation.MatchingResult:
        """
    ...
    def partition_closeness_simple(self, clustering: Clustering) -> evaluation.MatchingResult:
    ...
    def ecs(self, clustering: object, alpha: float = ..., r: float = ..., r2: float = ..., rescale_path_type: str = ..., ppr_implementation: str = ...) -> evaluation.MatchingResult:
        """
    ...
    def jaccard_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def rand_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def fowlkes_mallows_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def classification_error(self, clustering: object) -> evaluation.MatchingResult:
        """
        This function calculates the Jaccard index between two clusterings.
    ...
    def czekanowski_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def dice_index(self, clustering: object) -> evaluation.MatchingResult:
        """
        This function calculates the Czekanowski between two clusterings.
    ...
    def sorensen_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def rogers_tanimoto_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def southwood_index(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def mi(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def rmi(self, clustering: object, norm_type: str = ..., logbase: int = ...) -> evaluation.MatchingResult:
        """
    ...
    def geometric_accuracy(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def overlap_quality(self, clustering: object) -> evaluation.MatchingResult:
        """
    ...
    def sample_expected_sim(self, clustering: object, measure: str = ..., random_model: str = ..., n_samples: int = ..., keep_samples: bool = ...) -> evaluation.MatchingResult:
        """
