...
"""
@_utils.fill_doc
def img_to_signals_labels(imgs, labels_img, mask_img=..., background_label=..., order=..., strategy=...): # -> tuple[ndarray[Unknown, Unknown], list[Unknown]]:
...
@_utils.fill_doc
def img_to_signals_maps(imgs, maps_img, mask_img=...): # -> tuple[Unknown, list[Any]]:
    """Extract region signals from image.
