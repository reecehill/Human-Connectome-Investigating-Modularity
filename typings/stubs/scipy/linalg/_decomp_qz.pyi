...
__all__ = ['qz', 'ordqz']
_double_precision = ...
def qz(A, B, output=..., lwork=..., sort=..., overwrite_a=..., overwrite_b=..., check_finite=...): # -> tuple[Any, Any, Any, Any]:
    """
...
def ordqz(A, B, sort=..., output=..., overwrite_a=..., overwrite_b=..., check_finite=...): # -> tuple[Any, Any, Any, Any, Any, Any]:
