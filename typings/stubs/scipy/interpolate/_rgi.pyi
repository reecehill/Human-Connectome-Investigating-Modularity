...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    def __call__(self, xi, method=...): # -> ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Any]] | Any:
        """
...
def interpn(points, values, xi, method=..., bounds_error=..., fill_value=...): # -> ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Any]] | Any | None:
    """
