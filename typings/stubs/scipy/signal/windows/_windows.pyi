...
def general_cosine(M, a, sym=...): # -> NDArray[float64]:
    r"""
...
def boxcar(M, sym=...): # -> NDArray[float64] | ndarray[Any, dtype[Any]]:
...
def triang(M, sym=...): # -> NDArray[float64] | Any:
...
def parzen(M, sym=...): # -> NDArray[float64] | Any:
...
def bohman(M, sym=...): # -> NDArray[float64] | Any:
...
def blackman(M, sym=...): # -> NDArray[float64]:
    r"""
...
def nuttall(M, sym=...): # -> NDArray[float64]:
...
def blackmanharris(M, sym=...): # -> NDArray[float64]:
...
def flattop(M, sym=...): # -> NDArray[float64]:
...
def bartlett(M, sym=...): # -> NDArray[float64] | ndarray[Any, dtype[Any]]:
    r"""
...
def hann(M, sym=...): # -> NDArray[float64]:
    r"""
...
def tukey(M, alpha=..., sym=...): # -> NDArray[float64] | NDArray[Any]:
...
def barthann(M, sym=...): # -> NDArray[float64] | Any:
...
def general_hamming(M, alpha, sym=...): # -> NDArray[float64]:
...
def hamming(M, sym=...): # -> NDArray[float64]:
...
def kaiser(M, beta, sym=...): # -> NDArray[float64] | Any:
...
def kaiser_bessel_derived(M, beta, *, sym=...): # -> NDArray[Any]:
...
def gaussian(M, std, sym=...): # -> NDArray[float64] | Any:
...
def general_gaussian(M, p, sig, sym=...): # -> NDArray[float64] | Any:
...
def chebwin(M, at, sym=...): # -> NDArray[float64] | Any:
...
def cosine(M, sym=...): # -> NDArray[float64] | Any:
...
def exponential(M, center=..., tau=..., sym=...): # -> NDArray[float64] | Any:
...
def taylor(M, nbar=..., sll=..., norm=..., sym=...): # -> NDArray[float64] | Any:
    """
...
def dpss(M, NW, Kmax=..., sym=..., norm=..., return_ratios=...): # -> NDArray[float64] | tuple[Any, Any]:
    """
...
def lanczos(M, *, sym=...): # -> NDArray[float64] | Any:
...
_win_equiv = ...
_needs_param = ...
def get_window(window, Nx, fftbins=...): # -> NDArray[float64] | Any:
    """
