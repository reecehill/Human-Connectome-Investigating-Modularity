...
class LinearTimeInvariant:
    def __new__(cls, *system, **kwargs): # -> LinearTimeInvariant:
...
class lti(LinearTimeInvariant):
    ...
    *system : arguments
    ...
    """
    def __new__(cls, *system): # -> LinearTimeInvariant:
    ...
    def impulse(self, X0=..., T=..., N=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any], Any | NDArray[Any]]:
        """
    ...
    def step(self, X0=..., T=..., N=...): # -> tuple[Any | NDArray[floating[Any]], Any | NDArray[Any]]:
        """
    ...
    def output(self, U, T, X0=...): # -> tuple[Any, Any, NDArray[float64]] | tuple[NDArray[floating[Any]], NDArray[Any], Any]:
        """
...
class TransferFunction(LinearTimeInvariant):
    ...
    *system: arguments
    ...
    def to_zpk(self): # -> LinearTimeInvariant:
        """
    ...
    def to_ss(self): # -> LinearTimeInvariant:
        """
...
class TransferFunctionContinuous(TransferFunction, lti):
    ...
    *system: arguments
    ...
    """
    def to_discrete(self, dt, method=..., alpha=...): # -> LinearTimeInvariant:
        """
...
class ZerosPolesGain(LinearTimeInvariant):
    ...
    *system : arguments
    ...
    def to_tf(self): # -> LinearTimeInvariant:
        """
...
class StateSpace(LinearTimeInvariant):
    ...
    *system: arguments
    ...
    def __mul__(self, other): # -> _NotImplementedType | LinearTimeInvariant:
        """
    ...
    def __rmul__(self, other): # -> _NotImplementedType | LinearTimeInvariant:
        """Pre-multiply a scalar or matrix (but not StateSpace)"""
        ...
    
    def __neg__(self): # -> LinearTimeInvariant:
        """Negate the system (equivalent to pre-multiplying by -1)."""
        ...
    
    def __add__(self, other): # -> _NotImplementedType | LinearTimeInvariant:
        """
        Adds two systems in the sense of frequency domain addition.
        """
        ...
    
    def __sub__(self, other): # -> _NotImplementedType | LinearTimeInvariant:
        ...
    
    def __radd__(self, other): # -> _NotImplementedType | LinearTimeInvariant:
        ...
    
    def __rsub__(self, other): # -> _NotImplementedType:
        ...
    
    def __truediv__(self, other): # -> _NotImplementedType | LinearTimeInvariant:
        """
        Divide by a scalar
        """
        ...
    ...
    def to_tf(self, **kwargs): # -> LinearTimeInvariant:
        """
        Convert system representation to `TransferFunction`.
    ...
    def to_zpk(self, **kwargs): # -> LinearTimeInvariant:
        """
        Convert system representation to `ZerosPolesGain`.
...
def lsim2(system, U=..., T=..., X0=..., **kwargs): # -> tuple[NDArray[floating[Any]], NDArray[Any], Any]:
    """
...
def lsim(system, U, T, X0=..., interp=...): # -> tuple[Any, Any, NDArray[float64]] | tuple[NDArray[floating[Any]], NDArray[Any], Any]:
    """
...
def impulse(system, X0=..., T=..., N=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any], Any | NDArray[Any]]:
...
def impulse2(system, X0=..., T=..., N=..., **kwargs): # -> tuple[NDArray[floating[Any]], NDArray[Any]]:
    """
...
def step(system, X0=..., T=..., N=...): # -> tuple[Any | NDArray[floating[Any]], Any | NDArray[Any]]:
...
def step2(system, X0=..., T=..., N=..., **kwargs): # -> tuple[NDArray[floating[Any]], NDArray[Any]]:
    """Step response of continuous-time system.
