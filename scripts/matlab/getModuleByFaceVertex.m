function [moduleFacevert_L,moduleFacevert_R, nbmodules] = getModuleByFaceVertex(pathToFile,subject)
    ...
    L_cifti = ft_read_cifti([pathToFile,'/',subject,'/MNINonLinear/Results/tfMRI_MOTOR/tfMRI_MOTOR_hp200_s2_level2_MSMAll.feat/',subject,'_tfMRI_MOTOR_level2_hp200_s2_MSMAll_',subject,'_tfMRI_MOTOR_level2_LF-AVG_hp200_s2_MSMAll_ROI_L_clusters.dscalar.nii']);
    all_L_modules = L_cifti.dscalar(L_cifti.brainstructure==1);
    all_L_modules(isnan(all_L_modules)) = 0;
    R_cifti = ft_read_cifti([pathToFile,'/',subject,'/MNINonLinear/Results/tfMRI_MOTOR/tfMRI_MOTOR_hp200_s2_level2_MSMAll.feat/',subject,'_tfMRI_MOTOR_level2_hp200_s2_MSMAll_',subject,'_tfMRI_MOTOR_level2_LF-AVG_hp200_s2_MSMAll_ROI_R_clusters.dscalar.nii']);
