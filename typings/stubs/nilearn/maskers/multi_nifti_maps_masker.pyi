...
class MultiNiftiMapsMasker(NiftiMapsMasker):
    ...
    """
    def __init__(self, maps_img, mask_img=..., allow_overlap=..., smoothing_fwhm=..., standardize=..., standardize_confounds=..., high_variance_confounds=..., detrend=..., low_pass=..., high_pass=..., t_r=..., dtype=..., resampling_target=..., memory=..., memory_level=..., verbose=..., reports=..., n_jobs=...) -> None:
        ...
