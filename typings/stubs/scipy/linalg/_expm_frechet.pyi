...
def expm_frechet(A, E, method=..., compute_expm=..., check_finite=...): # -> tuple[Any, Any] | Any:
    """
...
def expm_frechet_block_enlarge(A, E): # -> tuple[Any, Any]:
    """
...
def expm_frechet_kronform(A, method=..., check_finite=...): # -> ndarray[Any, Any]:
    """
