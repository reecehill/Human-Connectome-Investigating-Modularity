...
"""
@fill_doc
def plot_matrix(mat, title=..., labels=..., figure=..., axes=..., colorbar=..., cmap=..., tri=..., auto_fit=..., grid=..., reorder=..., **kwargs): # -> AxesImage:
...
@fill_doc
def plot_design_matrix(design_matrix, rescale=..., ax=..., output_file=...): # -> Axes | None:
...
@fill_doc
def plot_event(model_event, cmap=..., output_file=..., **fig_kwargs): # -> Figure | None:
