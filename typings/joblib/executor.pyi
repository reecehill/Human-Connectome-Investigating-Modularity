...
"""
_executor_args = ...
def get_memmapping_executor(n_jobs, **kwargs): # -> Self@MemmappingExecutor:
    ...

class MemmappingExecutor(_ReusablePoolExecutor):
    @classmethod
    def get_memmapping_executor(cls, n_jobs, timeout=..., initializer=..., initargs=..., env=..., temp_folder=..., context_id=..., **backend_args): # -> Self@MemmappingExecutor:
