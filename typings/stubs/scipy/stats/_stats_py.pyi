...
def moment(a, moment=..., axis=..., nan_policy=..., *, center=...): # -> NDArray[Any] | float64 | NDArray[floating[_64Bit]]:
...
def iqr(x, axis=..., rng=..., scale=..., nan_policy=..., interpolation=..., keepdims=...): # -> ndarray[Any, dtype[Any]] | Any:
    r"""
