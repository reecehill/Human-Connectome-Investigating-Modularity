...
ModeResult = ...
def mode(a, axis=..., nan_policy=..., keepdims=...): # -> scipy.stats._stats_py.ModeResult | scipy.stats._mstats_basic.ModeResult:
...
def moment(a, moment=..., axis=..., nan_policy=...): # -> float64 | NDArray[floating[_64Bit]]:
...
def ttest_ind(a, b, axis=..., equal_var=..., nan_policy=..., permutations=..., random_state=..., alternative=..., trim=...): # -> scipy.stats._mstats_basic.Ttest_indResult | scipy.stats._stats_py.Ttest_indResult:
    """
...
def rankdata(a, method=..., *, axis=..., nan_policy=...): # -> NDArray[floating[_64Bit] | signedinteger[_NBitInt]] | NDArray[Any] | Any | NDArray[signedinteger[Any]]:
