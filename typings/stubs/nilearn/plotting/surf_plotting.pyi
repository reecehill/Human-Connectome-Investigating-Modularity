...
LAYOUT = ...
@fill_doc
def plot_surf(surf_mesh, surf_map=..., bg_map=..., hemi=..., view=..., engine=..., cmap=..., symmetric_cmap=..., colorbar=..., avg_method=..., threshold=..., alpha=..., bg_on_data=..., darkness=..., vmin=..., vmax=..., cbar_vmin=..., cbar_vmax=..., cbar_tick_format=..., title=..., title_font_size=..., output_file=..., axes=..., figure=..., **kwargs): # -> Figure | PlotlySurfaceFigure | None:
...
@fill_doc
def plot_surf_contours(surf_mesh, roi_map, axes=..., figure=..., levels=..., labels=..., colors=..., legend=..., cmap=..., title=..., output_file=..., **kwargs): # -> Figure | PlotlySurfaceFigure | None:
...
@fill_doc
def plot_surf_stat_map(surf_mesh, stat_map, bg_map=..., hemi=..., view=..., engine=..., threshold=..., alpha=..., vmax=..., cmap=..., colorbar=..., symmetric_cbar=..., cbar_tick_format=..., bg_on_data=..., darkness=..., title=..., title_font_size=..., output_file=..., axes=..., figure=..., **kwargs): # -> Figure | PlotlySurfaceFigure | None:
...
@fill_doc
def plot_img_on_surf(stat_map, surf_mesh=..., mask_img=..., hemispheres=..., inflate=..., views=..., output_file=..., title=..., colorbar=..., vmax=..., threshold=..., cmap=..., **kwargs): # -> tuple[Figure, list[Unknown]] | None:
...
@fill_doc
def plot_surf_roi(surf_mesh, roi_map, bg_map=..., hemi=..., view=..., engine=..., threshold=..., alpha=..., vmin=..., vmax=..., cmap=..., cbar_tick_format=..., bg_on_data=..., darkness=..., title=..., title_font_size=..., output_file=..., axes=..., figure=..., **kwargs): # -> Figure | PlotlySurfaceFigure | None:
