...
@docfiller
def mat_reader_factory(file_name, appendmat=..., **kwargs):
    """
...
@docfiller
def loadmat(file_name, mdict=..., appendmat=..., **kwargs):
    """
    Load MATLAB file.
...
@docfiller
def savemat(file_name, mdict, appendmat=..., format=..., long_field_names=..., do_compression=..., oned_as=...):
    """
...
@docfiller
def whosmat(file_name, appendmat=..., **kwargs):
    """
