...
def interp_decomp(A, eps_or_k, rand=...): # -> tuple[Any, Any, Any | ndarray[Any, dtype[Any]]] | tuple[Any, NDArray[Any] | Any | ndarray[Any, dtype[Any]]] | tuple[Any, Any, Any] | tuple[Any, Any]:
    """
...
def reconstruct_matrix_from_id(B, idx, proj): # -> Any | ndarray[Any, dtype[Any]]:
    """
