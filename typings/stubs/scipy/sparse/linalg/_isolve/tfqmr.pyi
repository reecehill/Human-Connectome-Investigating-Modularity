...
__all__ = ['tfqmr']
def tfqmr(A, b, x0=..., tol=..., maxiter=..., M=..., callback=..., atol=..., show=...): # -> tuple[ndarray[Any, Any], Literal[0]] | tuple[ndarray[Any, Any] | Any, Literal[-1]] | tuple[Any, Literal[0]] | tuple[ndarray[Any, Any] | Any, int | Any]:
    """
