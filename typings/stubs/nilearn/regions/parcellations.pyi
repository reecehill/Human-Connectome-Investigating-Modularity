...
class Parcellations(_MultiPCA):
 ...
 :class:`nilearn.maskers.MultiNiftiMasker`
    ...
    * This object uses spatially-constrained AgglomerativeClustering for
    ...
    @fill_doc
    def transform(self, imgs, confounds=...): # -> list[Unknown] | None:
 ...
 or :class:`pandas.DataFrame`, optional
    ...
    @fill_doc
    def fit_transform(self, imgs, confounds=...): # -> list[Unknown] | None:
 ...
 :class:`pandas.DataFrame`, optional
    ...
    @fill_doc
    def inverse_transform(self, signals): # -> list[Unknown] | None:
