...
class BaseAxes:
    ...
    """
    def __init__(self, ax, direction, coord) -> None:
        ...
...
class GlassBrainAxes(BaseAxes):
    ...
    """
    def __init__(self, ax, direction, coord, plot_abs=..., **kwargs) -> None:
        ...
    
    def transform_to_2d(self, data, affine): # -> NDArray[Unknown | Any]:
