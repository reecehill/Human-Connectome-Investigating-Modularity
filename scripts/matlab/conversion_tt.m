...
for i=1:str2num(nTrackIterations)
    nNotInAtlas = 0;
    ...
    parfor k=1:rawTrkLen
        ...
        %% Transform track coordinates from CRS into TkReg space
        ...
        if(isInDifferentSpace)
            ...
            % Register TkReg track endpoints from DSIStudio default to
            % subject.
            trkMatrix_registered_tkreg = trkMatrix_tkreg;
            trkMatrix_registered_tkreg_terminals = trkMatrix_tkreg_terminals;
        end
