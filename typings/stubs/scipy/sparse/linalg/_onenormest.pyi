...
"""
__all__ = ['onenormest']
def onenormest(A, t=..., itmax=..., compute_v=..., compute_w=...): # -> tuple[Any | ndarray[Any, Any] | Literal[0], ...] | tuple[Any | Literal[0], ...] | tuple[Any | Literal[0], ndarray[Any, Any]] | tuple[Any | Literal[0]] | Any | Literal[0]:
    """
...
def elementary_vector(n, i): # -> ndarray[Any, Any]:
    ...
