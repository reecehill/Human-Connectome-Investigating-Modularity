...
DEF_TINY = ...
DEF_DOFMAX = ...
def expression_to_contrast_vector(expression, design_columns): # -> NDArray[float64]:
...
def compute_fixed_effects(contrast_imgs, variance_imgs, mask=..., precision_weighted=...): # -> tuple[Unknown | Any | None, Unknown | Any | None, Unknown | Any | None]:
