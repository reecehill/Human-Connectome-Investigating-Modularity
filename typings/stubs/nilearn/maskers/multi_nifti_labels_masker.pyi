...
class MultiNiftiLabelsMasker(NiftiLabelsMasker):
    ...
    """
    def __init__(self, labels_img, labels=..., background_label=..., mask_img=..., smoothing_fwhm=..., standardize=..., standardize_confounds=..., high_variance_confounds=..., detrend=..., low_pass=..., high_pass=..., t_r=..., dtype=..., resampling_target=..., memory=..., memory_level=..., verbose=..., strategy=..., reports=..., n_jobs=...) -> None:
        ...
    
    def transform_imgs(self, imgs_list, confounds=..., n_jobs=..., sample_mask=...): # -> list[Unknown] | None:
