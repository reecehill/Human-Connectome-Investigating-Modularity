...
def firwin(numtaps, cutoff, width=..., window=..., pass_zero=..., scale=..., nyq=..., fs=...): # -> NDArray[floating[Any]] | Any:
    """
...
def firwin2(numtaps, freq, gain, nfreqs=..., window=..., nyq=..., antisymmetric=..., fs=...): # -> NDArray[floating[Any]] | Any:
    """
    FIR filter design using the window method.
...
def remez(numtaps, bands, desired, weight=..., Hz=..., type=..., maxiter=..., grid_density=..., fs=...):
    """
...
def firls(numtaps, bands, desired, weight=..., nyq=..., fs=...): # -> NDArray[floating[_NBitDouble]]:
    """
...
def minimum_phase(h, method=..., n_fft=...): # -> ndarray[Any, _dtype]:
