...
def reduce_array_memmap_backward(a): # -> tuple[(filename: Unknown, dtype: Unknown, mode: Unknown, offset: Unknown, order: Unknown, shape: Unknown, strides: Unknown, total_buffer_len: Unknown, unlink_on_gc_collect: Unknown) -> (memmap[Unknown, Unknown] | NDArray[Unknown]), tuple[str | None, Unknown, str, int, Literal['F', 'C'], Unknown, Unknown | None, Unknown | None, Literal[False]]] | tuple[(__data: ReadableBuffer, *, fix_imports: bool = True, encoding: str = "ASCII", errors: str = "strict", buffers: Iterable[Any] | None = ()) -> Any, tuple[bytes]]:
...
class ArrayMemmapForwardReducer:
    ...
    def __reduce__(self): # -> tuple[Type[ArrayMemmapForwardReducer], tuple[Unknown, None, Unknown, Unknown], dict[str, int | bool]]:
        ...
    
    def __call__(self, a): # -> tuple[(filename: Unknown, dtype: Unknown, mode: Unknown, offset: Unknown, order: Unknown, shape: Unknown, strides: Unknown, total_buffer_len: Unknown, unlink_on_gc_collect: Unknown) -> (memmap[Unknown, Unknown] | NDArray[Unknown]), tuple[str | None, Unknown, str, int, Literal['F', 'C'], Unknown, Unknown | None, Unknown | None, Literal[False]]] | tuple[(filename: Unknown, mmap_mode: Unknown, unlink_on_gc_collect: Unknown) -> Any, tuple[str, Unknown, Unknown]] | tuple[(__data: ReadableBuffer, *, fix_imports: bool = True, encoding: str = "ASCII", errors: str = "strict", buffers: Iterable[Any] | None = ()) -> Any, tuple[bytes]]:
        ...
