...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[floating[_NBitDouble]] | NDArray[Any], NDArray[float64]] | NDArray[floating[_NBitDouble]] | NDArray[Any] | tuple[NDArray[Any], Any]:
    """
...
def cdf2rdf(w, v): # -> tuple[NDArray[floating[_NBitDouble]], Any]:
    """
