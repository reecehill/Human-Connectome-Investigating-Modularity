...
def newton(func, x0, fprime=..., args=..., tol=..., maxiter=..., fprime2=..., x1=..., rtol=..., full_output=..., disp=...): # -> result | NDArray[Any] | NDArray[floating[Any]] | tuple[Any, RootResults]:
    """
...
class TOMS748Solver:
    ...
    def iterate(self): # -> tuple[Literal[0], Any | float] | tuple[Literal[0], float] | tuple[Literal[0, -2, 1], float]:
