...
wbCommandPath: str = "/gpfs01/software/imaging/workbench/workbench-1.5.0/bin_rh_linux64/wb_command" # From root, resolvable by Path.resolve(). Enter here to override automatic finding.
