...
from typing import Any, Generic, Literal as L, NamedTuple, SupportsIndex, SupportsInt, TypeAlias, TypeVar, overload
from numpy import complex128, complexfloating, float64, floating, generic, int32, object_, signedinteger, timedelta64, unsignedinteger
from numpy.linalg import LinAlgError as LinAlgError
from numpy._typing import ArrayLike, DTypeLike, NDArray, _ArrayLikeBool_co, _ArrayLikeComplex_co, _ArrayLikeFloat_co, _ArrayLikeInt_co, _ArrayLikeObject_co, _ArrayLikeTD64_co, _ArrayLikeUInt_co, _ArrayLikeUnknown
...
@overload
def outer(x1: _ArrayLikeComplex_co, x2: _ArrayLikeComplex_co) -> NDArray[complexfloating[Any, Any]]:
    ...

@overload
def outer(x1: _ArrayLikeTD64_co, x2: _ArrayLikeTD64_co, out: None = ...) -> NDArray[timedelta64]:
    ...
...
@overload
def outer(x1: _ArrayLikeComplex_co | _ArrayLikeTD64_co | _ArrayLikeObject_co, x2: _ArrayLikeComplex_co | _ArrayLikeTD64_co | _ArrayLikeObject_co) -> _ArrayType:
    ...
...
def svdvals(x: _ArrayLikeInt_co | _ArrayLikeFloat_co | _ArrayLikeComplex_co) -> NDArray[floating[Any]]:
    ...

def cond(x: _ArrayLikeComplex_co, p: None | float | L["fro", "nuc"] = ...) -> Any:
    ...

def matrix_rank(A: _ArrayLikeComplex_co, tol: None | _ArrayLikeFloat_co = ..., hermitian: bool = ..., *, rtol: None | _ArrayLikeFloat_co = ...) -> Any:
    ...
...
@overload
def matrix_norm(x: ArrayLike, ord: None | float | L["fro", "nuc"] = ..., keepdims: bool = ...) -> floating[Any]:
    ...

@overload
def matrix_norm(x: ArrayLike, ord: None | float | L["fro", "nuc"] = ..., keepdims: bool = ...) -> Any:
    ...

@overload
def vector_norm(x: ArrayLike, axis: None = ..., ord: None | float = ..., keepdims: bool = ...) -> floating[Any]:
    ...

@overload
def vector_norm(x: ArrayLike, axis: SupportsInt | SupportsIndex | tuple[int, ...] = ..., ord: None | float = ..., keepdims: bool = ...) -> Any:
    ...
...
def trace(x: ArrayLike, offset: SupportsIndex = ..., dtype: DTypeLike = ...) -> Any:
    ...

@overload
def cross(a: _ArrayLikeUInt_co, b: _ArrayLikeUInt_co, axis: int = ...) -> NDArray[unsignedinteger[Any]]:
    ...

@overload
def cross(a: _ArrayLikeInt_co, b: _ArrayLikeInt_co, axis: int = ...) -> NDArray[signedinteger[Any]]:
    ...

@overload
def cross(a: _ArrayLikeFloat_co, b: _ArrayLikeFloat_co, axis: int = ...) -> NDArray[floating[Any]]:
    ...

@overload
def cross(a: _ArrayLikeComplex_co, b: _ArrayLikeComplex_co, axis: int = ...) -> NDArray[complexfloating[Any, Any]]:
    ...

@overload
def matmul(x1: _ArrayLikeInt_co, x2: _ArrayLikeInt_co) -> NDArray[signedinteger[Any]]:
    ...

@overload
def matmul(x1: _ArrayLikeUInt_co, x2: _ArrayLikeUInt_co) -> NDArray[unsignedinteger[Any]]:
    ...

@overload
def matmul(x1: _ArrayLikeFloat_co, x2: _ArrayLikeFloat_co) -> NDArray[floating[Any]]:
    ...

@overload
def matmul(x1: _ArrayLikeComplex_co, x2: _ArrayLikeComplex_co) -> NDArray[complexfloating[Any, Any]]:
    ...
