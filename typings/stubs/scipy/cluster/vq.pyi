...
def vq(obs, code_book, check_finite=...): # -> tuple[Any, ndarray[Any, dtype[floating[Any]]]]:
    """
...
def py_vq(obs, code_book, check_finite=...): # -> tuple[Any, ndarray[Any, dtype[floating[Any]]]]:
...
def kmeans(obs, k_or_guess, iter=..., thresh=..., check_finite=..., *, seed=...): # -> tuple[NDArray[Any] | Any, float] | tuple[Any | NDArray[Any], float]:
    """
...
_valid_init_meth = ...
_valid_miss_meth = ...
def kmeans2(data, k, iter=..., thresh=..., minit=..., missing=..., check_finite=..., *, seed=...): # -> tuple[NDArray[Any] | Any, Any]:
    """
