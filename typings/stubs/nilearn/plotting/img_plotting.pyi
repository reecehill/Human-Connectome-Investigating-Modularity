...
@fill_doc
def plot_img(img, cut_coords=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., threshold=..., annotate=..., draw_cross=..., black_bg=..., colorbar=..., cbar_tick_format=..., resampling_interpolation=..., bg_img=..., vmin=..., vmax=..., **kwargs):
...
class _MNI152Template(SpatialImage):
    ...
    @property
    def affine(self): # -> NDArray[float64]:
        ...
    
    def get_affine(self): # -> NDArray[float64]:
        ...
...
MNI152TEMPLATE = ...
@fill_doc
def plot_anat(anat_img=..., cut_coords=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., annotate=..., threshold=..., draw_cross=..., black_bg=..., dim=..., cmap=..., colorbar=..., cbar_tick_format=..., vmin=..., vmax=..., **kwargs):
...
@fill_doc
def plot_epi(epi_img=..., cut_coords=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., annotate=..., draw_cross=..., black_bg=..., colorbar=..., cbar_tick_format=..., cmap=..., vmin=..., vmax=..., **kwargs):
...
@fill_doc
def plot_roi(roi_img, bg_img=..., cut_coords=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., annotate=..., draw_cross=..., black_bg=..., threshold=..., alpha=..., cmap=..., dim=..., colorbar=..., cbar_tick_format=..., vmin=..., vmax=..., resampling_interpolation=..., view_type=..., linewidths=..., **kwargs):
...
@fill_doc
def plot_prob_atlas(maps_img, bg_img=..., view_type=..., threshold=..., linewidths=..., cut_coords=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., annotate=..., draw_cross=..., black_bg=..., dim=..., colorbar=..., cmap=..., vmin=..., vmax=..., alpha=..., **kwargs): # -> None:
...
@fill_doc
def plot_stat_map(stat_map_img, bg_img=..., cut_coords=..., output_file=..., display_mode=..., colorbar=..., cbar_tick_format=..., figure=..., axes=..., title=..., threshold=..., annotate=..., draw_cross=..., black_bg=..., cmap=..., symmetric_cbar=..., dim=..., vmax=..., resampling_interpolation=..., **kwargs):
    """Plot cuts of an ROI/mask image (by default 3 cuts: Frontal, Axial, and
    Lateral)
...
@fill_doc
def plot_glass_brain(stat_map_img, output_file=..., display_mode=..., colorbar=..., cbar_tick_format=..., figure=..., axes=..., title=..., threshold=..., annotate=..., black_bg=..., cmap=..., alpha=..., vmin=..., vmax=..., plot_abs=..., symmetric_cbar=..., resampling_interpolation=..., **kwargs):
...
@fill_doc
def plot_connectome(adjacency_matrix, node_coords, node_color=..., node_size=..., edge_cmap=..., edge_vmin=..., edge_vmax=..., edge_threshold=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., annotate=..., black_bg=..., alpha=..., edge_kwargs=..., node_kwargs=..., colorbar=...): # -> None:
...
@fill_doc
def plot_markers(node_values, node_coords, node_size=..., node_cmap=..., node_vmin=..., node_vmax=..., node_threshold=..., alpha=..., output_file=..., display_mode=..., figure=..., axes=..., title=..., annotate=..., black_bg=..., node_kwargs=..., colorbar=...): # -> None:
...
@fill_doc
def plot_carpet(img, mask_img=..., mask_labels=..., t_r=..., detrend=..., output_file=..., figure=..., axes=..., vmin=..., vmax=..., title=..., cmap=..., cmap_labels=...):
