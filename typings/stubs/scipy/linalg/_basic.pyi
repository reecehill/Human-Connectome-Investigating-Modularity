...
def solve_toeplitz(c_or_cr, b, check_finite=...): # -> ndarray[Any, dtype[complexfloating[_64Bit, _64Bit] | floating[_64Bit]]] | Any | ndarray[Any, dtype[Any]]:
...
def pinv(a, *, atol=..., rtol=..., return_rank=..., check_finite=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any] | Any, Any] | NDArray[floating[Any]] | NDArray[Any] | Any:
    """
...
def matmul_toeplitz(c_or_cr, x, check_finite=..., workers=...): # -> ndarray[Any, dtype[complexfloating[_64Bit, _64Bit] | floating[_64Bit]]] | Any:
