...
class StoreBackendMixin:
    ...
    def dump_item(self, path, item, verbose=...): # -> None:
    ...
    def get_item_info(self, path): # -> dict[str, Unknown]:
    ...
    def get_cached_func_info(self, path): # -> dict[str, Unknown]:
    ...
    def reduce_store_size(self, bytes_limit): # -> None:
