...
def solve(a, b, sym_pos=..., lower=..., overwrite_a=..., overwrite_b=..., check_finite=..., assume_a=..., transposed=...): # -> ndarray[Any, Any]:
    """
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...): # -> ndarray[Any, Any]:
...
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[Any, tuple[ndarray[Any, Any], Any]] | tuple[Any, Any]:
    """
