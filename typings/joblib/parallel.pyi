...
EXTERNAL_BACKENDS = ...
def get_active_backend(prefer=..., require=..., verbose=...): # -> tuple[ThreadingBackend | SequentialBackend, Literal[1]] | Any:
...
class parallel_backend:
    ...
    def __enter__(self): # -> tuple[ThreadingBackend | SequentialBackend | Unknown, int]:
        ...
...
class BatchedCalls:
    ...
    def __reduce__(self): # -> tuple[Type[BatchedCalls], tuple[list[Unknown], tuple[Unknown, Unknown | None], None, Unknown | dict[Unknown, Unknown]]]:
        ...
...
def delayed(function): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), tuple[Unknown, tuple[Unknown, ...], dict[str, Unknown]]] | ((*args: Unknown, **kwargs: Unknown) -> tuple[Unknown, tuple[Unknown, ...], dict[str, Unknown]]):
...
class Parallel(Logger):
    ...
    '''
    def __init__(self, n_jobs=..., backend=..., verbose=..., timeout=..., pre_dispatch=..., batch_size=..., temp_folder=..., max_nbytes=..., mmap_mode=..., prefer=..., require=...) -> None:
        ...
    
    def __enter__(self): # -> Self@Parallel:
        ...
    ...
    def __call__(self, iterable): # -> list[Unknown] | None:
        ...
