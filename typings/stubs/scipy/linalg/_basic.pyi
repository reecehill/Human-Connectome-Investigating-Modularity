...
def solve(a, b, sym_pos=..., lower=..., overwrite_a=..., overwrite_b=..., check_finite=..., assume_a=..., transposed=...): # -> NDArray[floating[_NBitDouble]]:
    """
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...): # -> NDArray[complex128 | floating[_64Bit]] | ndarray[Any, _dtype] | NDArray[complex128]:
