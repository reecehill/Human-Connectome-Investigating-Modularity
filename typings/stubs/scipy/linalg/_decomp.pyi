...
_I = ...
def eig(a, b=..., left=..., right=..., overwrite_a=..., overwrite_b=..., check_finite=..., homogeneous_eigvals=...): # -> ndarray[Any, Any] | tuple[ndarray[Any, Any] | Any, ndarray[Any, Any] | Any, ndarray[Any, Any] | Any] | tuple[ndarray[Any, Any] | Any, ndarray[Any, Any] | Any]:
    """
...
def eigvals(a, b=..., overwrite_a=..., check_finite=..., homogeneous_eigvals=...): # -> ndarray[Any, Any] | tuple[ndarray[Any, Any] | Any, ndarray[Any, Any] | Any, ndarray[Any, Any] | Any] | tuple[ndarray[Any, Any] | Any, ndarray[Any, Any] | Any]:
    """
...
def eigvalsh_tridiagonal(d, e, select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> tuple[Any, Any]:
    """
...
def eigh_tridiagonal(d, e, eigvals_only=..., select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> tuple[Any, Any]:
    """
    Solve eigenvalue problem for a real symmetric tridiagonal matrix.
...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> tuple[ndarray[Any, Any] | Any, ndarray[Any, Any]] | ndarray[Any, Any] | tuple[Any, Any]:
    """
...
def cdf2rdf(w, v): # -> tuple[ndarray[Any, Any], Any]:
    """
