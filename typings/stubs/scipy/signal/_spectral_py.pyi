...
def periodogram(x, fs=..., window=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=...): # -> tuple[NDArray[float64], NDArray[float64]] | tuple[Any, Any | ndarray[Any, _dtype]]:
    """
...
def welch(x, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=..., average=...): # -> tuple[Any, Any | ndarray[Any, _dtype]]:
    r"""
...
def istft(Zxx, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., input_onesided=..., boundary=..., time_axis=..., freq_axis=..., scaling=...):
