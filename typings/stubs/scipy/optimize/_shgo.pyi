...
class SHGO:
    ...
    def simplex_minimizers(self): # -> NDArray[Any]:
        """
    ...
    def sorted_samples(self): # -> tuple[NDArray[intp], Any | ndarray[Any, Any]]:
    ...
    def minimizers_1D(self): # -> ndarray[Any, Any] | list[Any]:
        """
    ...
    def delaunay_minimizers(self): # -> ndarray[Any, Any] | list[Any]:
        """
        Returns the indices of all minimizers
        """
        ...
