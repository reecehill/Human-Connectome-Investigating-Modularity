...
def crop_img(img, rtol=..., copy=..., pad=..., return_offset=...): # -> Nifti1Image | FileBasedImage | tuple[Nifti1Image | FileBasedImage | Unknown, tuple[slice, ...]]:
...
def clean_img(imgs, runs=..., detrend=..., standardize=..., confounds=..., low_pass=..., high_pass=..., t_r=..., ensure_finite=..., mask_img=...): # -> list[Unknown] | Nifti1Image | FileBasedImage:
