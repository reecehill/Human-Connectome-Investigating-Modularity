...
_cnode_bare = ...
_cnode_type = ...
def cut_tree(Z, n_clusters=..., height=...): # -> NDArray[Any]:
    """
...
def cophenet(Z, Y=...): # -> NDArray[floating[_NBitDouble]] | tuple[Any, NDArray[floating[_NBitDouble]]]:
    """
...
def inconsistent(Z, d=...): # -> NDArray[floating[_NBitDouble]]:
    r"""
...
def from_mlab_linkage(Z): # -> NDArray[floating[_NBitDouble]]:
    """
...
def fcluster(Z, t, criterion=..., depth=..., R=..., monocrit=...): # -> NDArray[Any]:
    """
...
def fclusterdata(X, t, criterion=..., metric=..., depth=..., method=..., R=...): # -> NDArray[Any]:
    """
...
def maxdists(Z): # -> NDArray[float64]:
    """
...
def maxinconsts(Z, R): # -> NDArray[float64]:
    """
...
def maxRstat(Z, R, i): # -> NDArray[float64]:
    """
...
def leaders(Z, T): # -> tuple[NDArray[Any], NDArray[Any]]:
    """
