...
def tf2ss(num, den): # -> tuple[NDArray[Any], NDArray[Any], NDArray[Any], NDArray[Any]] | tuple[NDArray[float64], NDArray[float64], NDArray[float64], ndarray[Any, dtype[Any]] | Any] | tuple[Any, NDArray[float64], Any, ndarray[Any, dtype[Any]] | Any]:
...
def zpk2ss(z, p, k): # -> tuple[NDArray[Any], NDArray[Any], NDArray[Any], NDArray[Any]] | tuple[NDArray[float64], NDArray[float64], NDArray[float64], ndarray[Any, dtype[Any]] | Any] | tuple[Any, NDArray[float64], Any, ndarray[Any, dtype[Any]] | Any]:
