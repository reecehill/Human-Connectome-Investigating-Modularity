...
def spm_time_derivative(tr, oversampling=..., time_length=..., onset=...): # -> Any:
...
def glover_time_derivative(tr, oversampling=..., time_length=..., onset=...): # -> Any:
...
@fill_doc
def compute_regressor(exp_condition, hrf_model, frame_times, con_id=..., oversampling=..., fir_delays=..., min_onset=...): # -> tuple[Unknown, list[Unknown] | list[str]]:
