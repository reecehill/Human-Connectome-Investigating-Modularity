...
Mesh = ...
Surface = ...
def vol_to_surf(img, surf_mesh, radius=..., interpolation=..., kind=..., n_samples=..., mask_img=..., inner_mesh=..., depth=...): # -> Any | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown] | matrix[Any, Unknown]:
...
def load_surf_data(surf_data): # -> NDArray[Any]:
...
def check_mesh_and_data(mesh, data): # -> tuple[mesh, NDArray[Any]]:
