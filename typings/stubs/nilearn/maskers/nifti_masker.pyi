...
class NiftiMasker(BaseMasker, _utils.CacheMixin):
    ...
    """
    def __init__(self, mask_img=..., runs=..., smoothing_fwhm=..., standardize=..., standardize_confounds=..., detrend=..., high_variance_confounds=..., low_pass=..., high_pass=..., t_r=..., target_affine=..., target_shape=..., mask_strategy=..., mask_args=..., dtype=..., memory_level=..., memory=..., verbose=..., reports=...) -> None:
        ...
