...
__all__ = ["MatchingResult", "normalized_mutual_information", "overlapping_normalized_mutual_information_LFK", "overlapping_normalized_mutual_information_MGH", "omega", "f1", "nf1", "adjusted_rand_index", "adjusted_mutual_information", "variation_of_information", "partition_closeness_simple", "ecs", "jaccard_index", "rand_index", "fowlkes_mallows_index", "classification_error", "czekanowski_index", "dice_index", "sorensen_index", "rogers_tanimoto_index", "southwood_index", "mi", "rmi", "geometric_accuracy", "overlap_quality", "sample_expected_sim"]
MatchingResult = ...
def normalized_mutual_information(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def overlapping_normalized_mutual_information_LFK(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def overlapping_normalized_mutual_information_MGH(first_partition: object, second_partition: object, normalization: str = ...) -> MatchingResult:
    """
    Overlapping Normalized Mutual Information between two clusterings.
...
def adjusted_rand_index(first_partition: object, second_partition: object) -> MatchingResult:
...
def variation_of_information(first_partition: object, second_partition: object) -> MatchingResult:
...
def partition_closeness_simple(first_partition: object, second_partition: object) -> MatchingResult:
...
def ecs(first_partition: object, second_partition: object, alpha: float = ..., r: float = ..., r2: float = ..., rescale_path_type: str = ..., ppr_implementation: str = ...) -> MatchingResult:
    """
...
def jaccard_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def rand_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def fowlkes_mallows_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def classification_error(first_partition: object, second_partition: object) -> MatchingResult:
    """
    This function calculates the Jaccard index between two clusterings.
...
def czekanowski_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def dice_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
    This function calculates the Czekanowski between two clusterings.
...
def sorensen_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def rogers_tanimoto_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def southwood_index(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def mi(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def rmi(first_partition: object, second_partition: object, norm_type: str = ..., logbase: int = ...) -> MatchingResult:
    """
...
def geometric_accuracy(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def overlap_quality(first_partition: object, second_partition: object) -> MatchingResult:
    """
...
def sample_expected_sim(first_partition: object, second_partition: object, measure: str = ..., random_model: str = ..., n_samples: int = ..., keep_samples: bool = ...) -> MatchingResult:
    """
