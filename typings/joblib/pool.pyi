...
class CustomizablePicklingQueue:
    ...
    def __getstate__(self): # -> tuple[Unknown, Unknown, Unknown, Unknown | None, Unknown | None]:
        ...
...
class MemmappingPool(PicklingPool):
    ...
    """
    def __init__(self, processes=..., temp_folder=..., max_nbytes=..., mmap_mode=..., forward_reducers=..., backward_reducers=..., verbose=..., context_id=..., prewarm=..., **kwargs) -> None:
        ...
