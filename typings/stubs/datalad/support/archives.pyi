...
"""
if (cfg.obtain('datalad.runtime.use-patool', default=False, valtype=anything2bool) or not external_versions['cmd:7z']):
    ...
else:
    ...
lgr = ...
...
class ExtractedArchive:
    ...
    def get_extracted_files(self): # -> Generator[str, Any, None]:
