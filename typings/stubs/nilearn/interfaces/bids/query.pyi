...
def get_bids_files(main_path, file_tag=..., file_type=..., sub_label=..., modality_folder=..., filters=..., sub_folder=...): # -> list[Unknown] | list[str]:
...
def parse_bids_filename(img_path): # -> dict[Unknown, Unknown]:
