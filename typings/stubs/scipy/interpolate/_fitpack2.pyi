...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    def __call__(self, x, nu=..., ext=...): # -> NDArray[Any] | list[Any] | Any:
        """
    ...
    def integral(self, a, b): # -> list[Any] | tuple[Any, Any] | Any:
    ...
    def derivatives(self, x): # -> list[Any] | Any:
