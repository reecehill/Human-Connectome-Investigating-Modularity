...
from datalad.cmd import BatchedCommand, SafeDelCloseMixin, StdOutErrCapture, WitlessProtocol
from datalad.dataset.repo import RepoInterface
from datalad.dochelpers import borrowdoc, borrowkwargs
from datalad.runner.protocol import GeneratorMixIn
from datalad.runner.utils import AssemblingDecoderMixIn
...
class AnnexRepo(GitRepo, RepoInterface):
    ...
    repository_versions = ...
    _version_kludges = ...
    def __init__(self, path, runner=..., backend=..., always_commit=..., create=..., create_sanity_checks=..., init=..., batch_size=..., version=..., description=..., git_opts=..., annex_opts=..., annex_init_opts=..., repo=..., fake_dates=...) -> None:
    ...
    def is_managed_branch(self, branch=...): # -> bool | Literal[''] | None:
    ...
    def get_corresponding_branch(self, branch=...): # -> str | Any | None:
    ...
    def get_tracking_branch(self, branch=..., remote_only=..., corresponding=...): # -> tuple[str | None, str | None]:
    ...
    @classmethod
    def check_direct_mode_support(cls): # -> bool:
    ...
    def get_remotes(self, with_urls_only=..., exclude_special_remotes=...): # -> list[str]:
    ...
    def get_special_remotes(self, include_dead: bool = ...) -> Dict[str, dict]:
    ...
    def call_annex_records(self, args, files=...): # -> list[Any]:
    ...
    def call_annex(self, args, files=...):
    ...
    def call_annex_success(self, args, files=...): # -> bool:
    ...
    def call_annex_items_(self, args, files=..., sep=...): # -> Generator[str, Any, None]:
        ...
        See `_call_annex()` for information on Exceptions.
        """
        class GeneratorStdOutErrCapture(GeneratorMixIn, AssemblingDecoderMixIn, StdOutErrCapture):
            ...
        
        
    
    def call_annex_oneline(self, args, files=...): # -> str:
    ...
    @normalize_paths
    def get(self, files, remote=..., options=..., jobs=..., key=...): # -> list[Any]:
    ...
    @normalize_paths
    def add(self, files, git=..., backend=..., options=..., jobs=..., git_options=..., annex_options=..., update=...): # -> list[GitAddOutput | Any]:
    ...
    def add_(self, files, git=..., backend=..., options=..., jobs=..., git_options=..., annex_options=..., update=...): # -> Generator[GitAddOutput | Any, Any, None]:
        """Like `add`, but returns a generator"""
        ...
    
    @normalize_paths
    def get_file_key(self, files, batch=...): # -> str | int | list[str | int | Any | None] | None:
    ...
    @normalize_paths
    def unlock(self, files): # -> list[Any] | None:
    ...
    @normalize_paths
    def unannex(self, files, options=...): # -> list[Any]:
    ...
    def find(self, files, batch=...): # -> dict[Any, Any]:
    ...
    @normalize_paths
    def file_has_content(self, files, allow_quick=..., batch=...): # -> list[bool]:
    ...
    @normalize_paths
    def is_under_annex(self, files, allow_quick=..., batch=...): # -> list[bool]:
    ...
    def enable_remote(self, name, options=..., env=...): # -> None:
    ...
    @normalize_path
    def add_url_to_file(self, file_, url, options=..., backend=..., batch=..., git_options=..., annex_options=..., unlink_existing=...): # -> list[Any] | None:
    ...
    def add_urls(self, urls, options=..., backend=..., cwd=..., jobs=..., git_options=..., annex_options=...): # -> list[Any]:
    ...
    @normalize_path
    def get_urls(self, file_, key=..., batch=...): # -> dict[str, Any] | list[Any]:
    ...
    @normalize_paths
    def drop(self, files, options=..., key=..., jobs=...): # -> list[Any] | list[list[Any]]:
    ...
    @normalize_paths
    def whereis(self, files, output=..., key=..., options=..., batch=...): # -> list[list[Any]] | dict[Any | str, dict[Any, dict[str, Any]]] | None:
    ...
    @normalize_paths(map_filenames_back=True)
    def info(self, files, batch=..., fast=...): # -> dict[Any, Any]:
    ...
    def set_preferred_content(self, property, expr, remote=...): # -> str:
    ...
    def get_groupwanted(self, name): # -> str:
    ...
    def set_groupwanted(self, name, expr): # -> str:
    ...
    def get_contentlocation(self, key, batch=...): # -> str | list[Any] | None:
    ...
    @normalize_paths
    def get_file_backend(self, files): # -> list[str | int | Any | None]:
    ...
    @property
    def default_backends(self): # -> list[str | Any | bool] | Any | None:
        ...
    
    def fsck(self, paths=..., remote=..., fast=..., annex_options=..., git_options=...): # -> list[Any] | Any:
    ...
    def copy_to(self, files, remote, options=..., jobs=...): # -> list[Any]:
    ...
    def get_metadata(self, files, timestamps=..., batch=...): # -> Generator[tuple[str, Any | dict[Any, Any]], Any, None]:
    ...
    def set_metadata(self, files, reset=..., add=..., init=..., remove=..., purge=..., recursive=...): # -> list[Any]:
    ...
    def set_metadata_(self, files, reset=..., add=..., init=..., remove=..., purge=..., recursive=...): # -> Generator[Any, Any, None]:
        """Like set_metadata() but returns a generator"""
        ...
    
    def get_file_annexinfo(self, path, ref=..., eval_availability=..., key_prefix=...): # -> dict[Any, Any] | dict[str, str | int | None]:
    ...
    def get_content_annexinfo(self, paths=..., init=..., ref=..., eval_availability=..., key_prefix=..., **kwargs): # -> dict[Any, Any] | dict[Path, dict[str, str | int | None]] | str:
        """
        Parameters
        ----------
        paths : list or None
    ...
    def annexstatus(self, paths=..., untracked=...): # -> dict[Any, Any] | dict[Path, dict[str, str | int | None]] | str:
        """
        .. deprecated:: 0.16
    ...
    def localsync(self, remote=..., managed_only=...): # -> None:
...
class AnnexJsonProtocol(WitlessProtocol):
    ...
    def add_to_output(self, json_object): # -> None:
        ...
...
class AnnexInitOutput(WitlessProtocol, AssemblingDecoderMixIn):
    ...
    def pipe_data_received(self, fd, byts): # -> None:
        ...
...
class BatchedAnnex(BatchedCommand):
    ...
    """
    def __init__(self, annex_cmd, git_options=..., annex_options=..., path=..., json=..., output_proc=..., batch_opt=...) -> None:
        ...
...
class BatchedAnnexes(SafeDelCloseMixin, dict):
    ...
    def get(self, codename, annex_cmd=..., **kwargs) -> BatchedAnnex:
        ...
...
def readline_json(stdout): # -> Any | dict[Any, Any]:
    ...
