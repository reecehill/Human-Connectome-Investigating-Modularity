...
class CloudPickler(Pickler):
    ...
    if pickle.HIGHEST_PROTOCOL >= 5 and notPYPY:
        dispatch = ...
        def reducer_override(self, obj): # -> tuple[(origin: Unknown, args: Unknown) -> Unknown, tuple[Type[Literal] | None, Unknown] | tuple[Type[Final] | None, Unknown] | tuple[Type[ClassVar], Unknown] | tuple[Unknown, Unknown] | tuple[Type[Union], Unknown] | tuple[Type[Tuple[Unknown, ...]], Unknown] | tuple[Type[(...) -> Unknown], tuple[ellipsis | list[Unknown], Unknown]]] | tuple[Type[type], tuple[None]] | tuple[Type[type], tuple[ellipsis]] | tuple[Type[type], tuple[_NotImplementedType]] | tuple[(name: Unknown) -> (Type[type] | Any), tuple[Unknown]] | tuple[(bases: Unknown, name: Unknown, qualname: Unknown, members: Unknown, module: Unknown, class_tracker_id: Unknown, extra: Unknown) -> Unknown, tuple[tuple[type, ...], str, str, dict[str, Any], str, str | Unknown, None], tuple[dict[Unknown, Unknown], dict[Unknown, Unknown]], None, None, (obj: Unknown, state: Unknown) -> Unknown] | tuple[(type_constructor: Unknown, name: Unknown, bases: Unknown, type_kwargs: Unknown, class_tracker_id: Unknown, extra: Unknown) -> (Unknown | type), tuple[Any, Unknown, Any, dict[Unknown, Unknown], str | Unknown, None], tuple[dict[Unknown, Unknown], dict[Unknown, Unknown]], None, None, (obj: Unknown, state: Unknown) -> Unknown] | _NotImplementedType | tuple[(code: Unknown, globals: Unknown, name: Unknown, argdefs: Unknown, closure: Unknown) -> FunctionType, tuple[Unknown, Unknown, None, None, tuple[_Cell | Unknown, ...] | None], tuple[Unknown, dict[str, Unknown]], None, None, (obj: Unknown, state: Unknown) -> None]:
