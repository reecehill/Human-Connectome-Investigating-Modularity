...
def getdata(obj, dtype=..., copy=...): # -> NDArray[Any]:
    """
...
def isscalarlike(x): # -> TypeGuard[generic | bool | int | float | complex | str | bytes | memoryview[int]] | Literal[False]:
...
def issequence(t): # -> TypeGuard[generic | bool | int | float | complex | str | bytes | memoryview[int]] | bool:
    ...

def ismatrix(t): # -> TypeGuard[generic | bool | int | float | complex | str | bytes | memoryview[int]] | bool:
    ...
...
def check_shape(args, current_shape=...): # -> tuple[int, int]:
