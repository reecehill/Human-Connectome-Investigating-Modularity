function [moduleFacevert_L,moduleFacevert_R, nbmodules] = getModuleByFaceVertex(pathToFile,subject,conditionName)
    ...
    L_cifti = ft_read_cifti([pathToFile,'/MNINonLinear/Results/tfMRI_MOTOR/tfMRI_MOTOR_hp200_s2_level2_MSMAll.feat/',subject,'_tfMRI_MOTOR_level2_hp200_s2_MSMAll_',subject,'_tfMRI_MOTOR_level2_',conditionName,'-AVG_hp200_s2_MSMAll_ROI_L_clusters.dscalar.nii']);
    ...
    R_cifti = ft_read_cifti([pathToFile,'/MNINonLinear/Results/tfMRI_MOTOR/tfMRI_MOTOR_hp200_s2_level2_MSMAll.feat/',subject,'_tfMRI_MOTOR_level2_hp200_s2_MSMAll_',subject,'_tfMRI_MOTOR_level2_',conditionName,'-AVG_hp200_s2_MSMAll_ROI_R_clusters.dscalar.nii']);
