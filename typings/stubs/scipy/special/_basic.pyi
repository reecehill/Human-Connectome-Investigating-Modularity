...
def comb(N, k, exact=..., repetition=..., legacy=...): # -> ndarray[Any, Any] | float64 | Any:
...
def factorial(n, exact=...): # -> float | int | Any | NDArray[Any] | NDArray[floating[_64Bit]]:
    """
...
def factorial2(n, exact=...): # -> float | Any | NDArray[Any] | NDArray[floating[_64Bit]] | Literal[0, 1]:
    """Double factorial.
...
def factorialk(n, k, exact=...): # -> float | NDArray[Any] | NDArray[floating[_64Bit]] | Literal[0, 1]:
