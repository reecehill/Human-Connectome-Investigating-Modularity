...
def one_mesh_info(surf_map, surf_mesh, threshold=..., cmap=..., black_bg=..., bg_map=..., symmetric_cmap=..., vmax=..., vmin=...): # -> dict[Unknown, Unknown]:
...
def full_brain_info(volume_img, mesh=..., threshold=..., cmap=..., black_bg=..., symmetric_cmap=..., vmax=..., vmin=..., vol_to_surf_kwargs=...): # -> dict[Unknown, Unknown]:
...
@fill_doc
def view_img_on_surf(stat_map_img, surf_mesh=..., threshold=..., cmap=..., black_bg=..., vmax=..., vmin=..., symmetric_cmap=..., colorbar=..., colorbar_height=..., colorbar_fontsize=..., title=..., title_fontsize=..., vol_to_surf_kwargs=...): # -> SurfaceView:
...
def view_surf(surf_mesh, surf_map=..., bg_map=..., threshold=..., cmap=..., black_bg=..., vmax=..., vmin=..., symmetric_cmap=..., colorbar=..., colorbar_height=..., colorbar_fontsize=..., title=..., title_fontsize=...): # -> SurfaceView:
